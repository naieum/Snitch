...
const STORAGE_KEY = "snitch-desktop-theme";
...
export function ThemeProvider({ children }: { children: ReactNode }) {
  const [theme, setThemeState] = useState<Theme>(() => {
    try {
      ...
      if (stored === "cream" || stored === "midnight") return stored;
    } catch {}
    return "midnight";
  });
...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      style={{
        backgroundColor:
          theme === "midnight" ? "var(--bg-raised)" : "var(--accent)",
      }}
        ...
        style={{
          backgroundColor:
            theme === "midnight"
              ...
              : "var(--bg-surface)",
          transform:
            theme === "cream" ? "translateX(18px)" : "translateX(0)",
        }}
      >
        {theme === "midnight" ? "\u263E" : "\u2600"}
      </span>
