...
- **📜 License Compliance** (Cat 41) — copyleft contamination, license incompatibilities, missing license declarations
...
**Q3** `multiSelect: true` | header: `"Governance & Advanced"`
...
→ Display: "Invalid categories: 99, xyz. Please enter 1-45 or valid names."
→ Re-display menu
...
40-tunnels-dns.md, 41-license-compliance.md, 42-container-docker.md, 43-iac-security.md,
44-api-security.md, 45-ai-tool-supply-chain.md
...
- **If MCP is NOT connected:** `*This scan used 45 built-in categories. Connect to Snitch MCP for dynamic rules, custom rule creation, project memory, and tier-based scanning. → snitch.live*`
